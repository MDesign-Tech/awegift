  ...
  return (
    <div className="w-full bg-light-bg overflow-hidden">
      <Container className="container  w-full mx-auto overflow-hidden">
        <section
          ref={heroRef}
          className="relative gap-2 py-16 flex w-full overflow-hidden h-full items-center justify-center lg:justify-between"
        ...
        >
          ...
          >
            ...
            <div
              className="relative w-full h-max rounded-2xl overflow-hidden z-2"
              style={{
                scale: videoScale,
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-end justify-center pb-8"></div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-white md:w-60 md:h-80 rounded-2xl overflow-hidden group">
              ...
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5">
                {Array.from(
                  { length: Math.min(rightImages.length, 3) },
                  (_, i) => (
                    <div
                      key={i}
                      className={`w-2 h-2 rounded-full ${
                        i === (currentImageIndex - 1) % 3
                          ? "bg-white"
                          : "bg-white/40"
                      }`}
                    />
