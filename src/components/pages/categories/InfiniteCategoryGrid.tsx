...
const CategorySkeleton = () => (
  <div className="bg-white rounded-2xl shadow-md overflow-hidden h-full animate-pulse border border-gray-100">
...
const CategoryCard: React.FC<{ category: Category; index: number }> = ({
  ...
  const cardContent = (
    ...
    >
      {/* Image Container */}
      <div className="relative h-max lg:h-44 overflow-hidden">
        {category.url ? (
          <img
            src={category.url}
            alt={categoryName}
