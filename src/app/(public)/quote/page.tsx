              ...
              <div>
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setFormData(prev => ({ ...prev, products: [{ productId: null, name: "", quantity: 1 }] }));
                      setSelectedProductIds(new Set());
                    }}
                    disabled={formData.products.length <= 1}
                    className="flex items-center px-3 py-2 border border-red-300 text-red-600 rounded-md hover:bg-red-50 focus:ring-2 focus:ring-red-500 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
